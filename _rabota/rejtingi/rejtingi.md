...
|---|---|---|---|---|---|---|
| Doja · Prokupac | +6.0 | 1-е, 2024 | 95 | 3.9 | 70 | 1411 |
...
| Aleksandrović · Regent Reserve | +5.1 | 4-е, 2019 | 95 | 4.2 | 57 | 2335 |
...
Другой вопрос и другой ответ: не «что выгодно», а «что взять сегодня». Цена известна у 571 отобранных вин, медиана 1700 динаров.

| Вино | Критик | Vivino | Медали | Динаров |
|---|---|---|---|---|
| La Gora · Aria | 96 | — | 5 | 1900 |
| Aleksić · Amanet Vranac | 95 | 4.0 | 36 | 1738 |
| Doja · Prokupac | 95 | 3.9 | 70 | 1411 |
...
Полка супермаркета — не полка винотеки. Медиана бутылки 0,75 на полках Idea, Roda, Mercator, Maxi и portal-cenovnik — 1100 динаров против 1782 у винотек. Из 3646 обычных бутылок с нашими таблицами сошлись 426, и 193 из этих 426 в винотеке нет вовсе. Вот те, о которых есть что сказать.

Дешевле там, однако, не то же вино, а другое. Из 233 вин, которые продаются и в супермаркете, и в винотеке, дешевле в супермаркете 50: одна и та же бутылка на полке стоит в среднем на 16% дороже. В супермаркет идут не за скидкой на знакомое вино, а за тем, чего в винотеке нет.
...
Есть и третья полка — у самого хозяйства, и на ней то же вино обычно дешевле: в среднем на 9%. Цена известна и в винотеке, и в магазине винодельни у 120 вин; у винодельни дешевле 80 из них. Собственные магазины нашлись у 60 хозяйств, и там же стоят флагманы, которых в винотеках нет вовсе.

Четвёртая — витрина доставки: 68 лавок в Wolt, винотеки и оба гипермаркета Mercator'а. Она дороже полки, и насколько, теперь измерено на 764 вина, а не на четырёх бутылках: середина отношения 1.10, то есть примерно 10% сверху. Строка доставки идёт в счёт только там, где полочной цены нет вовсе, — а таких 338 вин.
...
| Radovanović · Cabernet Sauvignon | — | 4.3 | — | 1476 |
