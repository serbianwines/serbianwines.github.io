...
| Deurić · La Rem Chardonnay | +6.1 | — | 97 | — | 21 | 3960 |
...
Другой вопрос и другой ответ: не «что выгодно», а «что взять сегодня». Цена известна у 546 отобранных вин, медиана 1800 динаров.
...
| Vinarija Radovan · 100% Prokupac | 94 | — | 14 | 3200 |
...
Четвёртая — витрина доставки: 68 лавок в Wolt, винотеки и оба гипермаркета Mercator'а. Она дороже полки, и насколько, теперь измерено на 635 вин, а не на четырёх бутылках: середина отношения 1.07, то есть примерно 7% сверху. Строка доставки идёт в счёт только там, где полочной цены нет вовсе, — а таких 467 вин.
