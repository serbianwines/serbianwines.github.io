...
|---|---|---|---|
| оценка критика или медаль | 204 | 26 | 59 |
| только Vivino, выборка набрана | 85 | 31 | 4 |
| вина есть, оценок нет | 167 | 77 | 1 |
| **всего** | **456** | **134** | **64** |
...
167 хозяйств. Вина у них в сборе есть, но Vivino не показывает оценку — отзывов слишком мало, — и ни на один конкурс они не выходили. Справочнику рейтингов сказать о них нечего: не потому, что вино плохое, а потому, что его никто не оценил.
