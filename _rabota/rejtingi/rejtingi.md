...
Четвёртая — витрина доставки: 68 лавок в Wolt, винотеки и оба гипермаркета Mercator'а. Она дороже полки, и насколько, теперь измерено на 767 вин, а не на четырёх бутылках: середина отношения 1.11, то есть примерно 11% сверху. Строка доставки идёт в счёт только там, где полочной цены нет вовсе, — а таких 336 вин.
