...
def main():
    ...
    MAGAZINY = [("vinoteka", "vinoteka-ceny.json"),
                ...
                # Специализированные винные лавки со своих сайтов:
                # девять магазинов, у которых открыт Store API. Разряд
    ...
    # «lavki» сюда же, и по той же причине, что доставка. Медиана
    # винотеки считается по сырым строкам источника, а у этих девяти
    # лавок в каталоге весь мир: французское, итальянское, испанское.
