...
В сборе 436 хозяйств — все сербские винарии, каких удалось найти. Это не
...
1. **Оценка критика или медаль** — 142 хозяйства. Есть балл Decanter или
   Falstaff, или медаль конкурса. О таком хозяйстве справочник может
   сказать что-то проверяемое.
2. **Только Vivino, выборка набрана** — 112 хозяйств. Оценки критиков нет,
   но хотя бы одно вино держит 25 отзывов и больше. Порог тот же, что
   у пятёрок: ниже него средняя ничего не значит.
3. **Вина есть, оценок нет** — 180 хозяйств. Vivino знает их вина, но
   оценку не показывает: отзывов слишком мало. На конкурсы они не выходили.
4. **Ни вин, ни оценок** — таких не осталось.

Ступени 1 и 2 — 254 хозяйства — и есть тот круг, о котором справочник
рейтингов может говорить.

## Что из третьей ступени всё же стоит внимания

Сто восемьдесят «немых» хозяйств — не мусор. Девяносто шесть из них
нашлись в Винарском регистру, то есть это действующие производители
с лицензией; у девяноста четырёх известен рејон; десять уже названы
в книге — среди них Dukay, Weingut Jović, Аранђеловић 1920 и три
раjачких подрума. Шестьдесят два стоят в сборе с единственным вином.
...
десятый процентиль. Таких хозяйств десять, и среди них Navip: шесть вин,
...
**«Нет в Винарском регистру».** В регистре нашлись 280 хозяйств из 434.
Остальные 154 — не обязательно незарегистрированные: регистр пишет
...
То же и с десятью хозяйствами ниже нормы: сказать «Navip держит 3,4»
...
| Lakićević | — | 3 | 4.2 | 8 | 774 | 2025 |
| MV Vinarija | — | 1 | 4.2 | 2 | 103 | 2021 |
| Tri Oraha | — | — | 4.5 | 8 | 909 | — |
| Petica | — | — | 4.4 | 2 | 163 | — |
| Basha Vino | — | — | 4.3 | 2 | 106 | — |
| Monastery Visoki Decani  (Манастирско Дечанско) | — | — | 4.2 | 2 | 490 | — |
| Djokovic | — | — | 4.2 | 2 | 247 | — |
| Bojan Basa | — | — | 4.2 | 2 | 206 | — |
| Miletic | — | — | 4.2 | 4 | 155 | — |
| Vinarija Radlović | — | — | 4.2 | 1 | 28 | — |
| Брояница (Brojanica) | — | — | 4.1 | 7 | 6170 | — |
| Vinarija PIRG | — | — | 4.1 | 3 | 224 | — |
| Plavi Perun | — | — | 4.1 | 2 | 100 | — |
| Intuicija | — | — | 4.1 | 1 | 32 | — |
| Podrum Đorđević | — | — | 4 | 5 | 507 | — |
| Vršački Vinogradi | — | — | 4 | 6 | 503 | — |
| Serbika Wine | — | — | 4 | 4 | 262 | — |
| Chicha | — | — | 4 | 3 | 126 | — |
| Podrum Panajotovic | — | — | 4 | 1 | 47 | — |
| Vinarija Bogunovic | — | — | 4 | 1 | 44 | — |
| Vinska Kuća Rajić | — | — | 4 | 1 | 35 | — |
| Vinarija Bela Kula | — | — | 3.9 | 2 | 51 | — |
| Vinarija Vojnović | — | — | 3.9 | 1 | 27 | — |
| Vinogradi Nikolic | — | — | 3.8 | 1 | 70 | — |
| Nelt | — | — | 3.8 | 1 | 40 | — |
| M. Dubrana - N. Scheidt | — | — | 3.8 | 1 | 27 | — |
| Ilic Nijemcevic | — | — | 3.7 | 4 | 180 | — |
| Vinarija Đorđe | — | — | 3.7 | 1 | 25 | — |
| Boemi | — | — | 3.6 | 2 | 208 | — |
| Ukusi Moga Kraja | — | — | 3.6 | 2 | 91 | — |
| Robert Rudinski | — | — | 3.6 | 1 | 62 | — |
| Moderato | — | — | 3.6 | 1 | 38 | — |
...
180 хозяйств. Вина у них в сборе есть, но Vivino не показывает оценку — отзывов слишком мало, — и ни на один конкурс они не выходили. Справочнику рейтингов сказать о них нечего: не потому, что вино плохое, а потому, что его никто не оценил.

| Хозяйство | Вин в сборе | В Винарском регистру | Рејон |
|---|---|---|---|
| Vinarija Sočanski | 10 | да | Južnobanatski rejon |
...
| Lagum | 6 | не нашлось | — |
| Podrum Dremina | 6 | да | Rejon Tri Morave |
...
| Milanov Podrum | 5 | да | Rejon Tri Morave |
| Pimnica Perić | 5 | не нашлось | — |
| Podrum Jovanovic | 5 | да | — |
| Soul Wine | 5 | да | Južnobanatski rejon |
| Vinarija Blagojević | 5 | да | — |
| Vinarija KM | 5 | не нашлось | Sremski rejon |
...
| Dimalis | 3 | да | Rejon Telečka |
| Dukay | 3 | да | Potiski rejon |
...
| Vinarija Milojević | 3 | да | Beogradski rejon |
| Vinarija Mišić | 3 | да | — |
...
| Pet Hrastova | 2 | да | Rejon Tri Morave |
...
| Vinarija Baza | 2 | не нашлось | Rejon Bačka |
...
| Vinograd Hopovo | 2 | да | Sremski rejon |
...
| Janovi Vinogradi | 1 | не нашлось | Beogradski rejon |
| K-ing | 1 | не нашлось | — |
| Koreni | 1 | да | — |
| Krug Vinarija | 1 | не нашлось | — |
| Langov Podrum | 1 | да | Sremski rejon |
...
| Vinarija Praška | 1 | да | Sremski rejon |
...
| Винарија Манастира Студеница | 1 | да | Rejon Tri Morave |
