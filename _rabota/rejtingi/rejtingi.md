...
| Matalj · Kremen Kamen | 97 | 4.5 | 70 | 8712 |
...
|---|---|---|---|---|---|---|
| Doja · Prokupac | +6.0 | 1-е, 2024 | 95 | 3.9 | 70 | 1419 |
...
| Virtus · Morava | +6.1 | — | 95 | 3.9 | 12 | 1300 |
| Aleksandrović · Regent Reserve | +5.0 | 4-е, 2019 | 95 | 4.2 | 57 | 2442 |
| Virtus · Pinot Grigio | +4.0 | 3-е, 2022 | 93 | 3.8 | 33 | 1400 |
...
| Lakićević · Upupa | -7.9 | — | 82 | — | 4 | 2282 |
| Trivanović · Trigio Blanc | -7.0 | — | 82 | — | 1 | 1400 |

## Если в кармане 2000 динаров

Другой вопрос и другой ответ: не «что выгодно», а «что взять сегодня». Цена известна у 561 отобранных вин, медиана 1750 динаров.

| Вино | Критик | Vivino | Медали | Динаров |
|---|---|---|---|---|
| La Gora · Aria | 96 | — | 5 | 1900 |
| Aleksić · Amanet Vranac | 95 | 4.0 | 36 | 1738 |
| Doja · Prokupac | 95 | 3.9 | 70 | 1419 |
...
| Despotika · Morava Barik | 93 | — | 14 | 1560 |

## Что взять в супермаркете

Полка супермаркета — не полка винотеки. Медиана бутылки 0,75 на полках Idea, Roda, Mercator, Maxi и portal-cenovnik — 1100 динаров против 1782 у винотек. Из 3646 обычных бутылок с нашими таблицами сошлись 426, и 219 из этих 426 в винотеке нет вовсе. Вот те, о которых есть что сказать.

Дешевле там, однако, не то же вино, а другое. Из 207 вин, которые продаются и в супермаркете, и в винотеке, дешевле в супермаркете 43: одна и та же бутылка на полке стоит в среднем на 15% дороже. В супермаркет идут не за скидкой на знакомое вино, а за тем, чего в винотеке нет.
...
Есть и третья полка — у самого хозяйства, и на ней то же вино обычно дешевле: в среднем на 12%. Цена известна и в винотеке, и в магазине винодельни у 102 вина; у винодельни дешевле 81 из них. Собственные магазины нашлись у 60 хозяйств, и там же стоят флагманы, которых в винотеках нет вовсе.

Четвёртая — витрина доставки: 68 лавок в Wolt, винотеки и оба гипермаркета Mercator'а. Она дороже полки, и насколько, теперь измерено на 680 вин, а не на четырёх бутылках: середина отношения 1.07, то есть примерно 7% сверху. Строка доставки идёт в счёт только там, где полочной цены нет вовсе, — а таких 422 вина.
