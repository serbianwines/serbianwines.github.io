...
## За свои деньги: десятка до 2000 динаров

Цена известна у 228 вин из отобранных, медиана 2050 динаров. Связь цены с баллом критика слабая — коэффициент 0,27, и удвоение цены даёт всего балл, — поэтому список осмыслен: дорогое здесь не значит лучшее.
...
Тот же потолок, но ряд строит выборка Vivino. Ряд нужен отдельно: дешёвое вино на конкурс возят редко, и предыдущая таблица молчит как раз о самых ходовых бутылках.
