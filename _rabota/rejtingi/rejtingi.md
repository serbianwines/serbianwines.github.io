...
Цена известна у 228 вин из отобранных, медиана 2060 динаров. Связь цены с баллом критика слабая — коэффициент 0,27, и удвоение цены даёт всего балл, — поэтому список осмыслен: дорогое здесь не значит лучшее.
