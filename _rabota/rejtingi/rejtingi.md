...
| Aleksić · Amanet Vranac | 95 | 4.0 | 36 | 1790 |
...
| Aleksandrović · Kameničarka Prokupac | +7.2 | — | 97 | — | 15 | 2100 |
| Jović · Vranac Potrkanjski | +4.7 | 1-е, 2025 | 94 | — | 19 | 1635 |
...
| Deurić · La Rem Chardonnay | +6.0 | — | 97 | — | 21 | 3960 |
...
| Vinarija Gnezdo · Krokan | -8.8 | — | 81 | — | 1 | 2145 |
...
Другой вопрос и другой ответ: не «что выгодно», а «что взять сегодня». Цена известна у 480 отобранных вин, медиана 1788 динаров.

| Вино | Критик | Vivino | Медали | Динаров |
|---|---|---|---|---|
| Aleksić · Amanet Vranac | 95 | 4.0 | 36 | 1790 |
| Doja · Prokupac | 95 | 3.9 | 70 | 1460 |
| Tarpoš · Merlot | 95 | 4.0 | 17 | 1925 |
...
Четвёртая — витрина доставки: 58 винотек в Wolt. Она дороже полки, и насколько, теперь измерено на 532 вина, а не на четырёх бутылках: середина отношения 1.09, то есть примерно 9% сверху. Строка доставки идёт в счёт только там, где полочной цены нет вовсе, — а таких 308 вин.
