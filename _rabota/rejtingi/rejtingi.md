...
| Aleksandrović · Regent Reserve | +5.1 | 4-е, 2019 | 95 | 4.2 | 57 | 2442 |

Хвост того же ряда — вино, которое просит больше, чем даёт:

| Вино | Сверх ожидания | vino.rs | Критик | Vivino | Медали | Динаров |
|---|---|---|---|---|---|---|
| Temet · Dobra Godina | -9.7 | — | 84 | 4.3 | 10 | 21499 |
...
Другой вопрос и другой ответ: не «что выгодно», а «что взять сегодня». Цена известна у 526 отобранных вин, медиана 1790 динаров.
...
Четвёртая — витрина доставки: 68 лавок в Wolt, винотеки и оба гипермаркета Mercator'а. Она дороже полки, и насколько, теперь измерено на 622 вина, а не на четырёх бутылках: середина отношения 1.07, то есть примерно 7% сверху. Строка доставки идёт в счёт только там, где полочной цены нет вовсе, — а таких 440 вин.
